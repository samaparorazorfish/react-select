  ...
  * */
   ...
   */
	...
	handleInputBlur: function handleInputBlur(event) {
		if (this.refs.menu && document.activeElement === this.refs.menu.getDOMNode()) {
			this.getInputNode().focus();
			return;
		}
		...
		if(this.state.focusedOption && this.state.filteredOptions.length){
			onBlurredState.placeholder = this.state.focusedOption.label;
			onBlurredState.value = this.state.focusedOption.value;
		}
